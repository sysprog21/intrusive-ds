...
typedef struct hashnode_internal hashnode_t;
typedef struct hashtable_internal hashtable_t;

struct hashnode_internal {
    hashnode_t *next;
    size_t keylen;
    void *key;
};
...
void hashtable_insert(hashtable_t *table,
                      ...
                      void *key,
                      size_t keylen);
hashnode_t *hashtable_internalearch(hashtable_t *table,
                                    const void *key,
                                    size_t keylen);
hashnode_t *hashtable_search(hashtable_t *table,
                             const void *key,
                             size_t keylen);
